...
const STEPS = [
  ...
  },
  {
    ...
    text: 'В PRO доступны 7 направлений Оракула и Community Mixes. В Community можно публиковать свои рецепты, получать оценки, видеть рейтинг и делиться миксами с другими пользователями.',
    chips: ['7 направлений', 'Community Mixes', 'рейтинг', 'поделиться'],
  },
  {
    target: '#alxBottomNav',
    kicker: '06 · МОЙ ALX',
