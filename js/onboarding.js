...
const STEPS = [
  ...
  },
  {
    ...
    icon: 'PRO',
    title: 'Направления + Community',
    text: 'В PRO доступны 7 направлений Оракула и Community Mixes. В Community можно публиковать свои рецепты, получать оценки и делиться ими. Кнопка «Выбирать шаром» включает отдельный режим, где Оракул показывает миксы участников сообщества.',
    chips: ['7 направлений', 'Community Mixes', 'выбирать шаром', 'рейтинг'],
  },
  {
    target: '#alxBottomNav',
    kicker: '06 · МОЙ ALX',
    ...
    text: 'В «Мой ALX» находятся профиль вкуса, история, Микс дня, достижения, уведомления, PRO и твои Community-миксы. Здесь можно быстро вернуться к своим публикациям и их рейтингу.',
    chips: ['профиль вкуса', 'история', 'Community', 'достижения'],
  },
  {
    target: '#orbWrap',
    kicker: '07 · ГОТОВО',
