...
(() => {
  ...
  function collect() {
    ...
    return {
      mode:{plain:params.get('plain')==='1',noTransition:params.get('notransition')==='1',noComposite:params.get('nocomposite')==='1',noSweep:params.get('nosweep')==='1',noPseudo:params.get('nopseudo')==='1',ghost:params.get('ghost')==='1',label:params.get('label')==='1',isolate:params.get('isolate')==='1'},
      runtime:runtime(),
